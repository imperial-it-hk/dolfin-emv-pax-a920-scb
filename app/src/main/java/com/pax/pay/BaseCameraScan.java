...
/**
 * FileName: BaseCameraScan
 * Author: Minson
 * Created Date: 2022/2/27 20:45
    ...
    public void startCamera() {
        ...
        mCameraProviderFuture.addListener(() -> {
            ...
            try {
                ...
                //相机选择器
                int cameraNum = FinancialApplication.getApp().getCameraIdList();
                CameraSelector cameraSelector = null;
                if (cameraNum > 1) {
                    cameraSelector = mCameraConfig.options(new CameraSelector.Builder().requireLensFacing(CameraSelector.LENS_FACING_FRONT));
                } else {
                    cameraSelector = mCameraConfig.options(new CameraSelector.Builder().requireLensFacing(CameraSelector.LENS_FACING_BACK));
                }

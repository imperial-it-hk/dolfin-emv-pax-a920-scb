...
public enum CountryCode {
    ...
    private static final SparseArray<CountryCode> currencyNumericMap = new SparseArray<>();
    ...
    static {
        for (CountryCode cc : values()) {
            ...
            currencyNumericMap.put(cc.getCurrencyNumeric(), cc);
        }
    }
    ...
    public static CountryCode getByCurrencyCode(int code) {
        return currencyNumericMap.get(code);
    }
}
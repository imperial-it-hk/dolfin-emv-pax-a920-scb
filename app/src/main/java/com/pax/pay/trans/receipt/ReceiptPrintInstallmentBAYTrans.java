...
public class ReceiptPrintInstallmentBAYTrans extends ReceiptPrintTrans {
    ...
    public int print(TransData transData, boolean isRePrint, PrintListener listener) {
        ...
        if (receiptNum > 0) {
            ...
            for (; receiptNo < receiptNum; receiptNo++) {
                ReceiptGeneratorInstallmentBAYTrans genReceipt = new ReceiptGeneratorInstallmentBAYTrans(transData, receiptNo, receiptNum, isReprint);
    ...
    private int getVoucherNum() {
        ...
        Log.d(TAG, "ReceiptPrintInstalmentBAYTrans ---- NumbOfReceipt = " + receiptNum);
        return receiptNum;
    }
}

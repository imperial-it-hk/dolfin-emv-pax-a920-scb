...
import com.pax.pay.trans.action.activity.CheckQRWechatActivity;
...
public class ActionCheckQRWechat extends AAction {
     ...
     */
    public ActionCheckQRWechat(ActionStartListener listener) {
        super(listener);
    }
    ...
    protected void process() {
        Intent intent = new Intent(context, CheckQRWechatActivity.class);

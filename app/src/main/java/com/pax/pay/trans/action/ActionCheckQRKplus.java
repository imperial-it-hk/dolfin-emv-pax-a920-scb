...
public class ActionCheckQRKplus extends AAction {
     ...
     */
    public ActionCheckQRKplus(ActionStartListener listener) {
        super(listener);
    }
    ...
    protected void process() {
        Intent intent = new Intent(context, CheckQRKplusActivity.class);

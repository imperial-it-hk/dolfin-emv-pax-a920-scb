...
public class ActionGetQrAlipayFromServer extends AAction {
     ...
     */
    public ActionGetQrAlipayFromServer(ActionStartListener listener) {
        super(listener);
    }
        ...
        FinancialApplication.getApp().runInBackground(new Runnable() {
            ...
            public void run() {
                ...
                if (ret != TransResult.SUCC){
                    ...
                    transData.setTransType(ETransType.QR_INQUIRY_ALIPAY);
...
//                setResult(result);
    ...
    private void initTransDataQr(){
        ...
        Acquirer acquirer = acqManager.findAcquirer(Constants.ACQ_ALIPAY);
        Issuer issuer = acqManager.findIssuer(Constants.ISSUER_ALIPAY);
    ...
    private void initGetInfoTrans () {
        transData.setTransType(ETransType.GET_QR_ALIPAY);
        AcqManager acqManager = FinancialApplication.getAcqManager();
        Acquirer acquirer = acqManager.findAcquirer(Constants.ACQ_ALIPAY);
        Issuer issuer = acqManager.findIssuer(Constants.ISSUER_ALIPAY);
        transData.setTransState(TransData.ETransStatus.NORMAL);

...
public class ReceiptPrintInstalmentAmexTrans extends ReceiptPrintTrans {
    ...
    public int print(TransData transData, boolean isRePrint, PrintListener listener) {
        ...
        if (receiptNum > 0) {
            ...
            for (; receiptNo < receiptNum; receiptNo++) {
                ReceiptGeneratorInstalmentAmexTrans genReceipt = new ReceiptGeneratorInstalmentAmexTrans(transData, receiptNo, receiptNum, isReprint);
    ...
    private int getVoucherNum() {
        ...
        Log.d(TAG, "ReceiptPrintInstalmentAmexTrans ---- NumbOfReceipt = " + receiptNum);
        return receiptNum;
    }
}

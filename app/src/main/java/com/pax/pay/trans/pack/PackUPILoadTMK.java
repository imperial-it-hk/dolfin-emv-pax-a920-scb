...
public class PackUPILoadTMK extends PackIso8583 {

    private static String NETWORK_MGMT_INF_CODE_TMK_DOWNLOAD = "200";

    public PackUPILoadTMK(PackListener listener) {
        super(listener);
    }
    ...
    protected void setBitData60(@NonNull TransData transData) throws Iso8583Exception {
        ...
        byte[] field60 = Utils.concat(hardwareSN,NETWORK_MGMT_INF_CODE_TMK_DOWNLOAD.getBytes());

        setBitData("60", field60);
    }

    protected void setBitData62(@NonNull TransData transData) throws Iso8583Exception {
        setBitData("62", transData.getBytesField62());
    }
}

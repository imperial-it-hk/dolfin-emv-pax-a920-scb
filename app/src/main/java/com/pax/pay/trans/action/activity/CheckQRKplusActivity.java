...
public class CheckQRKplusActivity extends BaseActivityWithTickForAction {
    ...
    private void runInputPwdAction() {
        inputPasswordAction = new ActionInputPassword(new AAction.ActionStartListener() {
            ...
            public void onStart(AAction action) {
                ((ActionInputPassword) action).setParam(CheckQRKplusActivity.this, 6,
        ...
        inputPasswordAction.setEndListener(new AAction.ActionEndListener() {
            ...
            public void onEnd(AAction action, ActionResult result) {
                ...
                if (!data.equals(FinancialApplication.getSysParam().get(SysParam.StringParam.SEC_CANCEL_PWD))) {
                    DialogUtils.showErrMessage(CheckQRKplusActivity.this, getString(R.string.pwd_cancel),
...
//                TransProcessListener transProcessListenerImpl = new TransProcessListenerImpl(CheckQRKplusActivity.this);

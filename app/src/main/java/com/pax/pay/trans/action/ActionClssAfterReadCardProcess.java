...
public class ActionClssAfterReadCardProcess extends AAction {
    private Context context;
    private IClss clss;
    private TransData transData;
    private TransProcessListener transProcessListener;
    private ClssListenerImpl clssListener;
    private CTransResult cTransResult;

    private boolean isOnlineApproved;

    public ActionClssAfterReadCardProcess(ActionStartListener listener) {
        super(listener);
    }

    public void setParam(Context context, IClss clss, TransData transData, CTransResult result) {
        this.context = context;
        this.clss = clss;
        this.transData = transData;
        this.cTransResult = result;
    ...
    private class ProcessRunnable implements Runnable {
        ...
        public void run() {
            try {
                FinancialApplication.getApp().doEvent(new SearchCardEvent(SearchCardEvent.Status.CLSS_LIGHT_STATUS_READY_FOR_TXN));
                CTransResult result = clssTransProcess.afterReadCardProcess(cTransResult, clssListener);
                Device.beepPrompt();
        ...
        private void updateReversalStatus(boolean isSucc, TransData.ReversalStatus reversalStatus) {
            ...
            // for contactless no need to send TC-Advice
    ...
    public void setResult(ActionResult result) {
        ...
        Log.e("TLV", "9b:" + (value9B != null ? Utils.bcd2Str(value9B):""));

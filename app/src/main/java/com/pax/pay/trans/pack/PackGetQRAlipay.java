...
public class PackGetQRAlipay extends PackIso8583 {
    ...
    public PackGetQRAlipay(PackListener listener) {
        super(listener);
    }
    ...
    protected void setMandatoryData(@NonNull TransData transData) throws Iso8583Exception {
        ...
        if(transData.getTransType() == ETransType.QR_INQUIRY_ALIPAY){
    ...
    protected void setBitData63(@NonNull TransData transData) throws Iso8583Exception {
        ...
        if(transData.getTransType() == ETransType.GET_QR_ALIPAY){
        ...
        } else if (transData.getTransType() == ETransType.QR_INQUIRY_ALIPAY){
            //setBitData("63", /*initBuyerCode(transData) + Component.initPrintText()+*/initGetQR(transData));
            //setBitData("63", initGetQR(transData));
            setBitData("63", Utils.safeConvertByteArrayToString(initGetQR(transData)));
        }

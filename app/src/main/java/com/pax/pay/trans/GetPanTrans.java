...
public class GetPanTrans extends BaseTrans {
    ...
    public GetPanTrans(Context context, TransEndListener transListener) {
        super(context, ETransType.GET_PAN, transListener, true);
    }
    public GetPanTrans(Context context, TransEndListener transListener, boolean isGetThe1Card) {
        super(context, ETransType.GET_T1C_MEMBER_ID, transListener, true);
        this.isGetThe1CardMemberID = isGetThe1Card;
    }
       ...
       // search card action
        ActionSearchCard searchCardAction = new ActionSearchCardForPan(new AAction.ActionStartListener() {
            ...
            public void onStart(AAction action) {
                ((ActionSearchCard) action).setParam(getCurrentContext(), getString(R.string.trans_get_pan), mode, "000000000001",
                        null, "", transData, 9);
            }
        });

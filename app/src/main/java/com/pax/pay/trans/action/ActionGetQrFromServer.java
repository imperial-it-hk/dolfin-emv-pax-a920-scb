...
/**
 * Created by Nannaphat S on 09-Nov-18.
 */

public class ActionGetQrFromServer extends AAction {
     ...
     */
    public ActionGetQrFromServer(ActionStartListener listener) {
        super(listener);
    }
...
//                setResult(result);
    ...
    private void initGetInfoTrans () {
        ...
        transData.setTransType(ETransType.GET_QR_KPLUS);
        AcqManager acqManager = FinancialApplication.getAcqManager();
        Acquirer acquirer = acqManager.findAcquirer(Constants.ACQ_KPLUS);
        Issuer issuer = acqManager.findIssuer(Constants.ISSUER_KPLUS);

...
public class ReceiptPrintDetailReport extends AReceiptPrint {
    ...
    public ReceiptPrintDetailReport(Acquirer acquirer, PrintListener listener) {
        ...
        try {
            ...
            switch (acquirer.getName()) {
                ...
                case Constants.ACQ_DOLFIN_INSTALMENT:
                    bitmaps = new ReceiptGeneratorDetail(total, TITLE).generateBitmaps();
                    break;
                case Constants.ACQ_DCC:
                    bitmaps = new ReceiptGeneratorDetailDcc(total, TITLE).generateBitmaps();
                    break;
                case Constants.ACQ_REDEEM:
                case Constants.ACQ_REDEEM_BDMS:
                    bitmaps = new ReceiptGeneratorDetailRedeem(total, TITLE).generateBitmaps();
                    break;
                ...
                case Constants.ACQ_MY_PROMPT:
                    bitmaps = new ReceiptGeneratorDetailKBankWallet(total, TITLE).generateBitmaps();
                    break;

...
public class PackPreAuthorizationV2 extends PackIsoBase{

    public PackPreAuthorizationV2(PackListener listener) {
        super(listener);
    }
    ...
    private void setBitData53(TransData transData) {

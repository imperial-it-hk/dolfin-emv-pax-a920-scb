...
public class PackBayLoadTMK extends PackIso8583 {
    public PackBayLoadTMK(PackListener listener) {
        super(listener);
    }
    ...
    protected void setBitData62(@NonNull TransData transData) throws Iso8583Exception {
        TerminalEncryptionParam param = FinancialApplication.getUserParam().getTEParam(Bank.GCS);

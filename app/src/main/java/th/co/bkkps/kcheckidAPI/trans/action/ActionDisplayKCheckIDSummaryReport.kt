...
import th.co.bkkps.kcheckidAPI.trans.action.activity.KCheckIDDisplaySummaryReportActivity

class ActionDisplayKCheckIDSummaryReport(listener: ActionStartListener) : AAction(listener) {
    ...
    override fun process() {
        mContext?.let{
            val intent = Intent(it, KCheckIDDisplaySummaryReportActivity::class.java)

...
class KCheckIDInquiryStatusActivity : Activity() {

    companion object {
        const val TAG ="KCheckIDInquiryStatus"
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val inquiryReq = KCheckIDInquiryMsg.Companion.Request()
        inquiryReq.setSessionId(sessionID)
        //verifyReq.setStanNo(stanNumber.toLong())
        //verifyReq.setDateTime(SimpleDateFormat("yyyyMMdd HHmmss", Locale.US).format(Date()))
        transAPI.startTrans(this, inquiryReq as BaseRequest)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        try {
            val resp = transAPI.onResult(requestCode, resultCode, data) as KCheckIDInquiryMsg.Companion.Response?
            ...
            resp?.let { msg->
                ...
                val allowUpload = msg.getErmAllowUploadFlag()
                val eReceiptData: ByteArray? = msg.getErmReceiptData()
                val agentTransID: String = if (msg.getAgentTransId()!=null) msg.getAgentTransId()!! else " "
                if (allowUpload && eReceiptData != null) {
                    ...
                    if (allowUpload) {
                        ...
                        sendErcmUploadResult.setERMResult(-999)
...
//                        }
    ...
    fun uploadEReceipt(resp: KCheckIDInquiryMsg.Companion.Response) {
        try {
    ...
    fun doUploadReceipt(resp: KCheckIDInquiryMsg.Companion.Response) {
        ...
        val listener = AAction.ActionStartListener{
            ...
            val sessionID = resp.getSessionID();
            EReceiptUtils.setExternalAppUploadRawData(this, sessionID, acquirer, resp.getRequestReferenceId(), eReceiptData)

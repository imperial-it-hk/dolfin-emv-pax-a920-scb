...
public class ActionDolfinClearReversal extends AAction {
    public ActionDolfinClearReversal(ActionStartListener listener) {
        super(listener);
    }

    @Override
    protected void process() {
        String result = DolfinApi.getInstance().ClearReversal();
        ...
        try {
            ...
            Log.e("Dolfin","ClearReversal  json = " + json);
            Log.e("Dolfin","ClearReversal  respMsg = " + respMsg);

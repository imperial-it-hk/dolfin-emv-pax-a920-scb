...
public class ActionDolfinPrintSummary extends AAction {
    public ActionDolfinPrintSummary(ActionStartListener listener) {
        super(listener);
    }

    @Override
    protected void process() {
        String result = DolfinApi.getInstance().PrintSummary();

...
public class ActionDolfinPrintLastSettle extends AAction {
    public ActionDolfinPrintLastSettle(ActionStartListener listener) {
        super(listener);
    }

    @Override
    protected void process() {
        String result = DolfinApi.getInstance().ReprintSettle();

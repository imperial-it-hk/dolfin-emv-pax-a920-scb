...
public class ActionDolfinSale extends AAction {
    ...
    public ActionDolfinSale(ActionStartListener listener) {
        super(listener);
    }
    ...
    protected void process() {
            ...
            String result= DolfinApi.getInstance().Sale(mAmount,isPrintQR);

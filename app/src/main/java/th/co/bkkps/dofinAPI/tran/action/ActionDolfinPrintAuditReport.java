...
public class ActionDolfinPrintAuditReport extends AAction {
    public ActionDolfinPrintAuditReport(ActionStartListener listener) {
        super(listener);
    }

    @Override
    protected void process() {
        String result = DolfinApi.getInstance().PrintReport();

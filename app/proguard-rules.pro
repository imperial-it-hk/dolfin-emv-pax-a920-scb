...
#db/upgrade
-keep class com.pax.pay.db.upgrade.**{*;}

#TLE
-keepclassmembernames class com.pax.pay.trans.action.activity.**{*;}

#edc crc
-keep class th.co.bkkps.edc.**{*;}
-keep class com.pax.pay.base.**{*;}

-keep public class com.pax.pay.ECR.**{*;}

#linkpos api
-keep public class th.co.bkkps.linkposapi.**{*;}
